...
savefig = 'paper_plots/flux_pdf_masking_007_clustered_refreport.pdf'

################ new addition to mock up clustered CGM absorbers
civ_igm, v_lores = civ_cgm.igm_abs_init(skewerfile, logZ, fwhm, snr, seed, signif_thresh=3.0, min_peak_dist=50)
