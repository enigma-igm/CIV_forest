...
outfig = 'paper_plots/cf_varying_R_only_refreport.pdf'
...
plt.text(120, 0.82*ymax, r'log(M) = %0.2f M$_{\odot}$' % logM + '\n' + r'[C/H] = $%0.2f$' % logZ_fid, fontsize=legend_fontsize, linespacing=1.8)
